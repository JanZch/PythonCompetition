...
class Missile:
    ...
    def __init__(self, xMaxInput, yMaxInput, xMissileInit, yMissileInit, MissileScale, MissileVMin, MissileVMax, MissileDeltaThetaMin, MissileDeltaThetaMax):  # initialize object
        ...
        if xMissileInit == 0:  # start on the left
            self.thetaMissile = 0  # starting attitude
        elif xMissileInit == 1:  # start on the right
            self.thetaMissile = np.pi
        elif yMissileInit == 1:  # start at the top
